...
def get_user_list(config, key):
    with open("{}/KakashiManagementBot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_ID = 1866542500  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Avrazel"
