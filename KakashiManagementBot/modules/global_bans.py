...
import KakashiManagementBot.modules.sql.global_bans_sql as sql
from KakashiManagementBot.modules.sql.users_sql import get_user_com_chats
...
from KakashiManagementBot.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    if user_id in [777000, 1866542500]:
